 ...
 * { SforceEmail }
 */
use DoITCloudConsulting\Salesforce\Controllers\sfdc\SingleEmailMessage;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\MassEmailMessage;

/**
 * { SforceProcessRequest }
 */
use DoITCloudConsulting\Salesforce\Controllers\sfdc\ProcessSubmitRequest;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\ProcessWorkitemRequest;

/**
 * { ProxySettings }
 */
use DoITCloudConsulting\Salesforce\Controllers\sfdc\ProxySettings;


/**
 * { SforceHeaderOptions }
 */
use DoITCloudConsulting\Salesforce\Controllers\sfdc\CallOptions;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\AssignmentRuleHeader;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\MruHeader;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\LoginScopeHeader;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\QueryOptions;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\EmailHeader;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\UserTerritoryDeleteHeader;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\AllowFieldTruncationHeader;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\LocaleOptions;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\PackageVersionHeader;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\PackageVersion;

/**
 * { Internal Classes }
 */

use DoITCloudConsulting\Salesforce\Controllers\sfdc\SforceSearchResult;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\QueryResult;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\SObject; /** evaluar si es necesario que sea cargado aquí*/
...
class SforceBaseClient {
   ...
   *                       http://php.net/manual/en/soapclient.soapclient.php
	...
	public function login($username, $password) {
		...
		// var_dump($this->sforce);
		// var_dump($this->loginScopeHeader);
		...
		$result = $this->sforce->login( array ('username' => $username, 'password' => $password . 'PJgR3LoH2MhP30AsdDZ98GVe' ) );
