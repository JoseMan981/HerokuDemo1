...
namespace DoITCloudConsulting\Salesforce\Controllers;


use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use DoITCloudConsulting\Salesforce\Controllers\sfdc\SforcePartnerClient;
...
class Salesforce extends Controller
{
    ...
    function __construct()
    {
        ...
        try{
            ...
            $this->mySforceConnection->setEndpoint('https://creative-impala-v2pv6j-dev-ed.my.salesforce.com/services/Soap/m/52.0');

            $this->loginInfo = $this->mySforceConnection->login('josemanuel.rosales@demo.com', 'Hola1234@', 'WoUI5biGXusACbEi75WaDlThz');
